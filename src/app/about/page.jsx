      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            From digital transformation to IT consulting, we empower businesses
            to stay ahead.
          </motion.p>
        </div>
      </section>
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8 z-20 p-8 rounded-3xl bg-white/80 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              ...
              <p className="text-lg md:text-xl font-medium italic text-slate-800 mb-6 leading-relaxed">
                "Our goal is to build strong relationships through reliable
                service, measurable results, and a relentless focus on customer
                satisfaction."
              </p>
              ...
              <div className="border-t border-slate-200 pt-4">
                ...
                <p className="text-indigo-600 font-semibold text-sm tracking-wide">
                  Founder & CEO <span className="text-slate-300 px-1">|</span>{" "}
                  15+ Years Exp.
                </p>
              </div>
            </div>
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                Founded by <strong>Kavita Singh</strong>, a seasoned IT
                professional with over 15 years of experience, GAURANG INFOTECH
                was built on a simple premise: technology should empower, not
                complicate.
              </p>
            </motion.div>
            ...
            >
              <p className="text-slate-600 dark:text-slate-400">
                We specialize in delivering comprehensive IT solutions tailored
                to suit businesses of all sizes. Whether it's complex software
                development, secure cloud infrastructure, or strategic IT
                consulting, our approach is always{" "}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">
              We don't just deliver code; we deliver value, security, and
            ...
            {[
              {
                ...
                icon: HeartHandshake,
                desc: "Your goals are our priority. We listen, adapt, and deliver.",
              },
              {
                title: "End-to-End Solutions",
                icon: Target,
                desc: "From concept to deployment, we handle the entire lifecycle.",
              },
              {
                title: "Agile & Scalable",
                icon: Zap,
                desc: "Flexible services that grow as your business expands.",
              },
              {
              ...
              },
              {
                ...
                icon: Shield,
                desc: "Uncompromised protection for your data and infrastructure.",
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                ...
                className="group p-8 rounded-3xl bg-white shadow-md dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-indigo-100 dark:hover:border-indigo-900 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 hover:-translate-y-1"
              >
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-indigo-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            One solution at a time. Partner with Gaurang Infotech for a seamless
            digital transformation journey.
          </p>
          <div className="flex justify-center gap-4">
            <Button className="h-14 px-10 rounded-full bg-white text-indigo-600 hover:bg-indigo-50 font-bold text-lg shadow-xl cursor-pointer shadow-indigo-900/20 hover:-translate-y-1 transition-all duration-300" onClick={()=>router.push('/contactus')}>
              Get in Touch
            </Button>
          </div>
        </div>
